class InputRefactor:
    ...
    def __init__(self):
        self.red_dict = {"CC": "NULL", "CD": "NULL", "DT": "NULL", "EX": "NULL", "FW": "NULL", "IN": "NULL",
                         "JJ": "ADJECTIVE",
                         "JJR": "ADJECTIVE", "JJS": "ADJECTIVE", "LS": "NULL", "MD": "NULL", "NN": "NOUN",
                         "NNS": "NOUN",
                         "NNP": "NOUN", "NNPS": "NOUN", "PDT": "NULL", "POS": "NULL", "PRP": "PERSONAL",
                         "PRP$": "PERSONAL",
        ...
        self.exclusion_characters = [";", ":", "!", "!", "#", ",", ".", "@", "'", "£", "$", "%", "^", "&", "*", "(",
                                     ")", "\"", "{", "}", "]", "[", "~", "¬", "`"]  # used in nonLetterRemover

    def nonLetterRemover(self, sentence):
        """Removes Unnecessary Commas and Determines if it is a question"""
